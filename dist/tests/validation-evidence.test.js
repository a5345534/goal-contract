...
import { SUPPORTED_REQUIRED_EVIDENCE, SUPPORTED_REQUIRED_EVIDENCE_SET, isSupportedRequiredEvidence, requireSupportedRequiredEvidence, } from "../validation-evidence.js";
...
test("requireSupportedRequiredEvidence throws for unsupported token", () => {
    assert.throws(() => requireSupportedRequiredEvidence("pnpm test passes", "test.path"), /requiredEvidence/);
});
...
//# sourceMappingURL=validation-evidence.test.js.map